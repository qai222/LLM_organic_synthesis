...
example2_reaction_text = ```To a solution of 2-Aminoxy-acetic acid ethyl ester (573 mg, 4.8 mmol) and 4-Pentynoic acid (441 mg, 4.5 mmol) in 15 mL EtOAc were added dicyclohexylcarbodiimide (928 mg, 4.5 mmol) and the resulting mixture was stirred at room temperature for 16 h.```
