...
connection_string = "postgresql://127.0.0.1:5432/ord"
...
def ord_add_data(dataset_id: str, local_data_folder: str = "/home/qai/workplace/ord-data/data", uspto_only=True):
...
def get_dataset_ids():
    with open("dataset_ids_20230328.txt", "r") as f:
...
if __name__ == '__main__':
    ...
    for index, i in tqdm(enumerate(get_dataset_ids())):
        ...
        ord_add_data(base_id, uspto_only=True, local_data_folder="/home/qai/workplace/ord-data/data")
