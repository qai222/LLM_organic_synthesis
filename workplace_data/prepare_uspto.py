...
def make_USPTO_split(
        master_dataset: LlmDataset, total_size: int, n_token_limit: int, name: str = None,
...
if __name__ == '__main__':
    ...
    make_USPTO_split(USPTO_MASTER, 100 * 1000, 2048, explicit_policy=1)
